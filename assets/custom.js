...
$(document).ready(function () {
    ...
    // Temporary workaround for Maruku double-escaping HTML entities in <code> elements
    $(".exercise").find("code").each(function() {
      var $codeBlock = $(this);


      // Don't do replacements on syntax-highlighted blocks
      if ($codeBlock.attr("class") === undefined) {
        $codeBlock.text(function(_, text) {
